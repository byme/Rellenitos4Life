...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {       //Cambio de escena
            ...
            if (nextSceneIndex < SceneManager.sceneCountInBuildSettings)
            {
                ...
                transform.position =  startPosition   ; // Restablece la posici�n del jugador al inicio del nuevo nivel
            }
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        {
            startPosition = transform.position; // Actualiza la posici�n de inicio del jugador al cargar un nuevo nivel
